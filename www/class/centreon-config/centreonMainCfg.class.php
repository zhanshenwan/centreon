...
class CentreonMainCfg
{
    ...
    const EVENT_BROKER_TO_LOG = [
        ...
        16 => 'Initial host state',
        32 => 'Initial service state',
        64 => 'External command',
        128 => 'Passive host check',
        256 => 'Passive service check',
        512 => 'Runtime error/warning'
    ];
    ...
    /**
     * Explode the bitwise event broker to log to an array for QuickForm
     *
     * @param int $value The value to explode
     * @return array An array of integer
     */
    public function explodeEventBrokerToLog($value)
    {
        return $this->explodeBitwise($value, self::EVENT_BROKER_TO_LOG);
    }
